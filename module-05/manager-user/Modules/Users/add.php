...
if (isPost()) {
    ...
    if (empty($validation_errors)) {
        $data = [
            'Email' => trim($body['email']),
            'Password' => password_hash(trim($body['pass']), PASSWORD_DEFAULT),
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="password" name="pass" class="form-control" placeholder="Nhập mật khẩu..." tabindex='4'>
                    <?= formError('pass'); ?>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="password" name="repass" class="form-control" placeholder="Nhập lại mật khẩu..." tabindex='5'>
                    <?= formError('repass'); ?>
                </div>
            </div>
        </div>
